...
//Create New Event
  const handleclick = async (event) => {
    ...
    try {
      await axios.post('https://conferece-app.onrender.com/create-event', payload, config);
  ...
  //Calendar Display
  useEffect(() => {
    axios.get('https://conferece-app.onrender.com/get-events')
      .then((d) => {
  ...
  useEffect(() => {
    ...
    console.log(myString)
    axios.get(`https://conferece-app.onrender.com/getuserevent/${myString}`)
      .then((d) => {
  ...
  const handleEdit = () => {
    ...
    axios.put(`https://conferece-app.onrender.com/update-event/${id}`, Credentials)
      .then((d) => {
  ...
  const handleDelete = () => {
    ...
    axios.delete(`https://conferece-app.onrender.com/delete-event/${id}`)
      .then((d) => {
        setData(d.data)
      })
      .catch((e) => { console.log(e) })
